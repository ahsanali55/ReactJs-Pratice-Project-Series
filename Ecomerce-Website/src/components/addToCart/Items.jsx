      ...
      {cartItem?.map((item) => (
        ...
        <div className="flex justify-between px-3 py-5 border border-gray-300">
          ...
          <div className="flex items-center gap-7 ">
            ...
            <h1 className="text-[22px] font-semibold text-[#292C30]">{item?.name}</h1>
          </div>
          {/* Right */}
          <div className="flex items-center gap-7">
            <h3 className="text-gray-500 mr-14">{item?.price.toString().split(".")[0]} $</h3>
            <div className="flex items-center">
              <button className="border border-gray-300 rounded-l-lg px-10 py-2 font-semibold "
              ...
              <button className="border border-gray-300 rounded-r-lg px-10 py-2 font-semibold tracking-widest "
              onClick={() => handleCartDecrement(item)}
              >
                -
              </button>
            </div>
            <button className="border-2 text-white bg-[#292C30] hover:border-2 hover:border-[#292C30] hover:bg-white hover:text-[#292C30] duration-75 px-20 py-2 rounded-md"
