      ...
      shadow-gray-300 p-3 relative flex flex-col justify-between items-start gap-2"
        >
          ...
          <div className="min-h-[70px]">
            <p className="text-gray-700 tracking-wide font-normal  ">{item.description}</p>
          </div>
         ...
         "
          ...
          <div className="flex items-center gap-4 py-4">
            ...
            <div className="flex relative">
              <button className="px-5 py-1 border border-gray-300 rounded-l-lg text-2xl font-extrabold cursor-pointer"
              ...
              <button className="cursor-pointer px-5 py-1 border border-gray-300 rounded-r-lg text-2xl font-extrabold relative" 
